                ...
                <div class="card-body">
                    <form action="{{ route('posts.update', $post->id) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" id="title" name="title" type="text" value="{{ old('title', $post->title) }}">
                                    @if ($errors->has('title'))
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
<textarea class="form-control{{ $errors->has('body') ? ' is-invalid' : '' }}" id="body" name="body" rows="3">{!! old('body', $post->body) !!}</textarea>
                                @if ($errors->has('body'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>
                                        {{ $errors->first('body') }}
